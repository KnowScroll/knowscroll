...
| [Unleased direct withdrawal #75](https://github.com/KnowScroll/knowscroll/issues/75) | Coordinator lifecycle/schema, bounded implementation and independent privacy review | Next: queued/recovered cancellation and DB expiry with safe withdrawal clocks, unknown-liability preservation and no new execution authority |
