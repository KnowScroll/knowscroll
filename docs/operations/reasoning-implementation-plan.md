...
| [Sealed literal Ask context #66](https://github.com/KnowScroll/knowscroll/issues/66) | Coordinator schema/family routing/locks, Sol compiler, independent Terra contract and privacy review | Exact original-session Ask/Job binding, eight typed source reads, no execution creation; Clear and retirement replay remain source-only |
| [Unleased direct withdrawal #75](https://github.com/KnowScroll/knowscroll/issues/75) | Coordinator lifecycle/schema, bounded implementation and independent privacy review | Implemented: original-session queued/recovered cancellation, actual DB expiry, atomic fairness closure and rotating maintenance; unknown liabilities remain retained and no execution authority is created |
| [Completed/failed private retirement #81](https://github.com/KnowScroll/knowscroll/issues/81) | Coordinator migration/maintenance/process proof; MiniMax M3 independent review and SQL test author | Owner-approved 168-hour finish clock, safe terminal guard, populated0011 upgrade and bounded private retirement; no completion consumer or provider authority |
...
3. [#64](explicit-asks.md) implements source-only literal Ask durability. [#66](reasoning-ask-context.md) adds Ask-specific context; exact direct-intent Job lifecycle and H/H2 coalescing remain required when those execution consumers are introduced; optional children must inherit budget and release waiting-parent execution slots.
4. [#62](reasoning-retirement.md) integrates the retained-accounting purge with seven-day safely withdrawn cancelled/expired private-graph retirement in a separate scheduled worker. [ADR-0019/#81](../decisions/0019-completed-failed-private-retirement.md) adds the owner-approved168-hour finished-context retention guard and maintenance; a trusted completion/application consumer and product privacy controls/copy remain required before sending private context. Account deletion and backup retention remain separate unresolved requirements.
