...
layer every planet is drawn on an orbit ring with a moon and land shapes, and the planet level shows
authored continents, currents and clouds; none of it is data. Its label used to say only that
