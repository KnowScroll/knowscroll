...
- Cosmos illustrates ignition from attention counts and sub-concept spread. The real system requires semantic evidence that a concept explains multiple regions; graph degree and watching cannot create a foundational Star by themselves.
- A kept item is a Relic with an explicit Trace. The prototype’s Keep-moon is an open visual exploration; it does not redefine a semantic Moon as a save counter.
- A room agreeing does not settle truth or automatically turn a black hole into a Star. Evidence and typed gates decide semantic mutations.
...
A coherent dark origin, a readable sourced Scroll, an explicit Keep and return to real traces. It does not prove the full pan/zoom/nested geography, rich interactive blocks, horizontal branches, video lifecycle, or long-term world emergence. Those remain acceptance criteria of the Android and product issues.
