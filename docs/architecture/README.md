...
| API | Auth boundary, admission, client contracts | Single-owner development only |
| Ledger | Event identity, order, causation and durable admission | PostgreSQL source events |
...
| Evaluation / Operations | Journey receipts, quality and current runtime inspection | J001 + live state command |
