...
const unreadCandidate: SignalCandidate = {asset,sourceKey:asset.sourceUrl,sourceTitle:asset.sourceTitle,exposureCount:0,lastExposedAtMs:null,sourceExposureCount:0};
