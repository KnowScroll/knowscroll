...
-- personal model: Clear/Reset erase it, deletion removes it with the universe, export leaves it out.
CREATE TABLE correction_catch_up (
 universe_id uuid PRIMARY KEY REFERENCES universe(id) ON DELETE CASCADE,
